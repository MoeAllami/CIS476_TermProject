// app/dashboard/cars/edit/[id]/page.jsx
"use client";
    ...
    if (status === "authenticated" && carId) {
      const fetchCarData = async () => {
        ...
        try {
          ...
          if (!response.ok) {
            throw new Error(data.message || "Failed to fetch car data");
          }
          ...
          const carData = {
            ...
            pricePerDay: data.pricing?.daily || "",
  ...
  if (status === "loading" || isFetching) {
    return (
      <div className="max-w-4xl mx-auto py-8 px-4">
        ...
        <div className="text-center py-12">Loading car data...</div>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto py-8 px-4">
        ...
        <div className="bg-red-50 border-l-4 border-red-400 p-4 mb-6">
          <p className="text-sm text-red-700">
            You must be logged in to edit a car. Redirecting to login...
          </p>
        </div>
      </div>
    );
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-sm text-gray-500 mb-4">
              You can manage specific availability dates in the calendar
              settings.
            </p>
          </div>
